  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      setOffset((o) => {
        const delta = 5;
        switch (e.key) {
          case "ArrowUp": return { ...o, x: o.x + delta };
          case "ArrowDown": return { ...o, x: o.x - delta };
          case "ArrowLeft": return { ...o, y: o.y + delta };
          case "ArrowRight": return { ...o, y: o.y - delta };
          case "q": return { ...o, z: o.z - delta };
          case "e": return { ...o, z: o.z + delta };
          default: return o;
        }
      });
    };
  ...
  return (
    <div className="w-screen h-[80vh] relative">
      ...
      <div className="absolute top-4 left-4 text-white bg-black/60 px-4 py-2 rounded shadow">
        Offsets → X: {Math.round(offset.x) % 360}°, Y: {Math.round(offset.y) % 360}°, Z: {Math.round(offset.z) % 360}°
