            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="text-sm space-y-1">
                            ...
                            <li className="flex items-center gap-2">
                                ...
                                <a href="mailto:malcouronnejulien@gmail.com" className="font-bold">malcouronnejulien@gmail.com</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="md:col-span-2 space-y-8 print:order-1">
                    ...
                    <section>
                        ...
                        <p className="text-sm">Développeur front-end avec plus de 3 ans d’expérience, passionné par la création d’interfaces web performantes et élégantes. Actuellement Tech Lead chez ClimateSeed, je combine expertise technique et coordination d'équipe pour livrer des solutions robustes et évolutives.</p>
                    </section>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold border-b pb-1 mb-2 uppercase">Expériences complémentaires</h2>
                        <div className="space-y-4 text-sm">
                            <div>
